...
## Entrenamiento, validación y cálculo de parámetros del modelo
...
for(degree in degreeValues) {
  ...
  # Cálculo de parámetros para ese K-fold
  params = c(0, 0, 0, 0)
...
cat("Accuracy: ", bestParams[1], "\n")
cat("Precision: ", bestParams[2], "\n")
cat("Recall: ", bestParams[3], "\n")
cat("Specificity: ", bestParams[4], "\n")
cat("Best degree: ", bestDegree, "\n")
